...
const Footer = () => {
  ...
  const data = {
    socialLinks: {
      facebook: 'https://facebook.com/vision-creations',
      twitter: 'https://twitter.com/vision-creations',
      instagram: 'https://instagram.com/vision-creations',
      linkedin: 'https://linkedin.com/vision-creations',
    ...
    main: {
      ...
      description:
        'Vision Creations Architectural Design is a full-service Architectural design company located in the Bangalore, Specializing in both residential and commercial design and execution.',
    },
  };
  return (
    <footer className='text-center lg:text-left bg-gray-100 text-gray-600'>
      <div className='flex justify-center items-center lg:justify-between p-6 border-b border-gray-300 w-11/12 mx-auto'>
        ...
        <div className='grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-24'>
          ...
          <div className=''>
            ...
            <p className='mb-2 md:mb-4'>
              <Link className='text-gray-600' href='/projects'>
                Projects
              </Link>
            </p>
            <p className='mb-2 md:mb-4'>
            ...
            <p className='mb-2 md:mb-4'>
              <Link className='text-gray-600' href='/careers'>
                Careers
              </Link>
            </p>
          </div>
          <div className=''>
            ...
            <p className='flex items-center justify-center md:justify-start mb-2 md:mb-4'>
              <svg
                aria-hidden='true'
                focusable='false'
                data-prefix='fas'
